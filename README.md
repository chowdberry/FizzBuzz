...
- Variable types are written inside the script. 
- Void is used instead of 'None'
- Python uses colons for if statements and for loops, Java uses curly braces{}
- Instead of using 'and', Java uses '&&'
- Instead of using 'print', Java uses 'SystemOut'
